        ...
        <div>
            ...
            <main className="main-news">
                ...
                <div className="container-news">
                    ...
                    <p>Um navio que veio da Holanda e atracou no Porto de Santos, em outubro, trouxe o primeiro carregamento de fertilizante lower carbon, ou seja, um material produzido com baixíssimo carbono que irá auxiliar na descarbonização do agronegócio brasileiro.
                    ...
                    No começo de dezembro, o Brasil começará a produção interna do fertilizante de baixíssimo carbono, utilizando biometano, na planta da empresa Yara, em Cubatão, em São Paulo.</p>
                </div>
            </main>
            <Footer />
        </div>
